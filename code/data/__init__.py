...
def create_dataset(dataset_opt):
    ...
    elif mode == 'Colourization':  # progressive colorization, 4 levels, target is high-resolution color images
        from data.Colourization_dataset import ColourizationDataset as D
    else:
